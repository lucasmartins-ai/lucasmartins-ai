...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,fastapi,nextjs,nodejs,react,ts,js,html,css,tailwind,postgres,sqlite,aws,azure,gcp,docker,linux,c,cpp,go,rust&theme=dark" alt="LOOKADEV Visual Stack Grid" />
  </a>
</div>
...
| [**talentsift-open**](https://github.com/lucasmartins-ai/talentsift-open) | `TypeScript` `React` | Local-first AI-assisted CV review and candidate scoring system with deterministic evaluation. |
| [**ai-reception-lite**](https://github.com/lucasmartins-ai/ai-reception-lite) | `TypeScript` `Next.js` | Self-contained AI receptionist for small-business lead capture, automated qualification, and immediate follow-up. |
...
<details open>
<summary><b>💼 Fullstack SaaS, Business OS &amp; Industry Systems</b> (11 Projects)</summary>
...
<details open>
<summary><b>⚡ Cybersecurity, High-Performance Systems &amp; Low-Level</b> (6 Projects)</summary>
